...
public class ItemEnemyWeapon extends ItemSword {
    ...
    public static final String[] ids = {"bokostick", "darknut_sword"};
    private static final float[] attackDamage = {2.0f, 6.5f};
    private static final float[] attackSpeed = {-1.5f, -3.5f};
    private static final int[] durability = {50, 200};
